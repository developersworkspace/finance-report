...
export class AccountService {
  ...
  protected homeLoanBondAccount(): Account {
    return new Account([
      ...
      new AccountBalance(-393097.25, 3673.49, 4655.27, new Date(2018, 8, 30)),
  ...
  protected homeLoanFlexiAccount(): Account {
    return new Account([
      ...
      new AccountBalance(50000, null, null, new Date(2018, 8, 30)),
  ...
  protected savingsAccount(): Account {
    return new Account([
      ...
      new AccountBalance(23354.82 + 10000, null, null, new Date(2018, 8, 30)),
    ], true, false, 'Savings');
  }
