...
export class AccountService {
  ...
  protected chequeAccount(): Account {
    return new Account([
      ...
      new AccountBalance(8000, null, null, new Date(2018, 7, 31)),
    ], true, false, 'Cheque');
  }
  ...
  protected creditAccount(): Account {
    return new Account([
      ...
      new AccountBalance(0, null, null, new Date(2018, 7, 31)),
    ], false, false, 'Credit');
  }
  ...
  protected homeLoanBondAccount(): Account {
    return new Account([
      ...
      new AccountBalance(-423710.03, 3716.53, 4655.27, new Date(2018, 7, 31)),
  ...
  protected homeLoanFlexiAccount(): Account {
    return new Account([
      ...
      new AccountBalance(20300.00, null, null, new Date(2018, 7, 31)),
  ...
  protected propertyAccount(): Account {
    return new Account([
      ...
      new AccountBalance(850000, null, null, new Date(2018, 7, 31)),
  ...
  protected savingsAccount(): Account {
    return new Account([
      ...
      new AccountBalance(41584.64 + 12000, null, null, new Date(2018, 7, 31)),
    ], true, false, 'Savings');
  }
